  ...
  >
    <Variant title="Default with learn more URL">
      <div class="p-6 bg-n-background">
        <FeatureSpotlight
          title="Aly Assistant"
          note="Aly Assistant engages directly with customers, learns from your help docs and past conversations, and delivers instant, accurate responses. It handles the initial queries, providing quick resolutions before transferring to an agent when needed."
          video-url=""
          thumbnail=""
          ...
          learn-more-url="https://stage.thumb-crowd.com/hc/user-guide/articles/1757933715-creating-an-assistant-with-aly-brain"
        />
      </div>
    </Variant>
