...
export var excellent = () => {
   ...
   */
  excellent.Parser.prototype.evaluate = function(expression, context) {
    if (context) {
  ...
  /**
   * Evaluate multiple expressions in a text
   */
  excellent.Parser.prototype.evaluateText = function(text, context) {
    if (context) {
      this.evaluator.setContext(context);
    }
  ...
  /**
   * Set the context for the evaluator
   */
  excellent.Parser.prototype.setContext = function(context) {
    this.evaluator.setContext(context);
  };
   ...
   */
  excellent.Parser.prototype.getContext = function() {
