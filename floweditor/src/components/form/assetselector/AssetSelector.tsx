...
> {
  ...
  public render(): JSX.Element {
    console.log('🔍 AssetSelector render - props.name:', this.props.name);
    console.log(
      '🔍 AssetSelector render - state.entry.value:',
      this.state.entry.value,
    );
    console.log('🔍 AssetSelector render - props.assets:', this.props.assets);
    console.log('🔍 AssetSelector render - props.multi:', this.props.multi);
    console.log('🔍 AssetSelector render - props.entry:', this.props.entry);
    ...
    return (
      ...
      >
        <TembaSelect
          ...
          valueKey={
            this.props.valueKey ||
            (this.props.assets && this.props.assets.type === AssetType.Channel
              ? 'id'
              : this.props.assets
              ? this.props.assets.id
              : undefined) ||
            'uuid'
          }
          ...
          errors={
            this.props.errorMessage
              ? [this.props.errorMessage]
              : getAllErrorMessages(this.state.entry)
          }
