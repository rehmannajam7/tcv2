  ...
  functions: [
    ...
    },
    {
      ...
      examples: [
        {
          template:
            '@(attachment_parts("image/jpeg:https://example.com/test.jpg"))',
          output:
            '{content_type: image/jpeg, url: https://example.com/test.jpg}',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      summary:
        'Retorna o número de items em uma matriz ou propriedades em um objeto.',
      detail:
    ...
    },
    {
      ...
      summary:
        'Retorna a duração entre `date1` e `date2` na `unit` especificada.',
      detail:
        'Durações válidas são "Y" para anos, "M" para meses, "W" para semanas, "D" para dias, "h" para hora,\n"m" para minutos, "s" para segundos.',
      examples: [
        {
    ...
    },
    {
      ...
      examples: [
        ...
        {
          template:
            '@(foreach_value(object("a", "hi there", "b", "good bye"), word, 1))',
    ...
    },
    {
      ...
      examples: [
        ...
        {
          template:
            '@(format_date("1979-07-18T15:00:00.000000Z", "YYYY-MM-DD"))',
          output: '1979-07-18',
        },
        {
          template:
            '@(format_date("2010-05-10T19:50:00.000000Z", "YYYY M DD"))',
          output: '2010 5 10',
        },
        {
    ...
    },
    {
      ...
      examples: [
        ...
        {
          template:
            '@(format_datetime("1979-07-18T15:00:00.000000Z", "YYYY-MM-DD"))',
          output: '1979-07-18',
        },
        {
          template:
            '@(format_datetime("2010-05-10T19:50:00.000000Z", "YYYY M DD tt:mm"))',
    ...
    },
    {
      ...
      summary:
        'Retorna `value1` se `test` é verdadeiro ou `value2` caso contrário.',
    ...
    },
    {
      ...
      summary:
        'Junta o `array` dado de strings com o `separator` para fazer o texto.',
      detail: '',
      examples: [
        {
          template: '@(join(array("a", "b", "c"), "|"))',
    ...
    },
    {
      ...
      detail:
        'Se o texto dado não é um JSON válido, então um erro é retornado.',
      examples: [
        {
    ...
    },
    {
      ...
      summary:
        'Substitui até em até `count` ocorrências de `needle` por `replacement` em `text`.',
      detail:
    ...
    },
    {
      ...
      summary:
        'Arredonda `number` para o número inteiro inferior mais próximo.',
      detail:
    ...
    },
    {
      ...
      summary:
        'Retorna o tamanho (número de caracteres) de `value` quando convertido em texto.',
      detail: '',
      examples: [
        {
    ...
    },
    {
      ...
      summary:
        'Remove espaço em branco de qualquer uma das extremidades do `text`.',
      detail:
...
exports.handler = (evt, ctx, cb) =>
  cb(null, getOpts({ body: JSON.stringify(completion) }));
