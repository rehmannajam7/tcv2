    ...
    types: [
      ...
      },
      {
        ...
        properties: [
          ...
          {
            key: 'tel_e164',
            help: 'the telephone number for the contact, in E164 format',
            type: 'text',
          },
          {
            key: 'email',
            help: 'the email address for the contact',
            type: 'text',
          },
          {
            key: 'address',
            help: 'the address for the contact',
            type: 'text',
          },
          {
            key: 'groups',
      ...
      },
      {
        ...
        properties: [
          ...
          },
          {
            key: 'user',
            help:
              'the user who started this session if this is a manual trigger',
            type: 'text',
          },
          {
            key: 'origin',
...
const { getOpts } = require('./utils/index.js');
